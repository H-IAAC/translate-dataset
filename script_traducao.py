...
caminho_pasta_saida = (
    "traducao_final"  # Substitua pelo caminho real da pasta de saída (opcional)
)
idioma_destino = (
    "pt"  # Substitua pelo idioma de destino desejado (exemplo: 'pt' para português)
)
caminho_chave_api = "skilful-answer-390621-00fe41eacd9e.json"  # Substitua pelo caminho real do arquivo JSON da chave de API

traduzir_csv(
    caminho_pasta_entrada, caminho_pasta_saida, idioma_destino, caminho_chave_api
)
